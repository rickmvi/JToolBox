...
public interface Condition {
    ...
    static @NotNull Condition.Runner isTrue(boolean condition, Runnable action) {
        return new Runner(condition, action);
    }

    @Contract("_ -> new")
    static @NotNull Condition.Runner when(boolean condition) {
     ...
     *
     * @deprecated Use {@link Condition#supplyTrue(boolean, Supplier)} followed by {@link Suppliers#getOptional()}.
     */
    @Deprecated
    @Contract("_, _ -> !null")
