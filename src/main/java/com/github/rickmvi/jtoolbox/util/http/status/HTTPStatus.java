package com.github.rickmvi.jtoolbox.util.http.status;
...
public enum HTTPStatus {
    ...
    /**
     * Returns an {@code HTTPStatus} instance corresponding to the provided HTTP status code.
     * If the given code does not match any defined status, {@code UNKNOWN_STATUS} is returned.
     *
     * @param code the HTTP status code for which the corresponding {@code HTTPStatus} is to be retrieved
