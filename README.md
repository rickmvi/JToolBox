...
- [Pacote `debug`](/src/main/java/com/github/rickmvi/jtoolbox/logger/README.md): Sistema de log extensível com múltiplos níveis (`INFO`, `DEBUG`, `ERROR`, etc), suporte a cores ANSI, mensagens com placeholders, controle dinâmico de visibilidade e tratamento de exceções — ideal para debugging detalhado e visual.
